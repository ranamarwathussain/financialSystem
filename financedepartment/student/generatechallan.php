...
extract($_GET);
$query = "Select * from challan where challanstatus='Pending' and challanid='$regnumber'";
$rs = $conn->query($query);
$rows = $rs->fetch_assoc();
?>
<!DOCTYPE html>
<html>
<head>
	<title>Challan-<?php echo  $rows['regnumber']?></title>
	<meta charset="utf-8">
				...
				<div class="table-responsive" >
					...
					<table  class="table">
						...
						<tbody>
						 ...
						 <tr class="total" style="text-align:left;background-color:#000000;color: white;">
							...
							<tr class="total" style="text-align:left;color: white;">
								<td></td>
								<td style="text-align:left;color: white;background-color:#000000">Within Due date:<br> PKR <?php echo  $rows['fee']+$rows['otherfee']?> 
								 </td>
							</tr>
					 ...
					 <div >
					 	...
					 	<b><p style="font-size: 12px;text-align: justify;">Account Number for Fee Deposit:<br>
					 	1. Faysal Bank<br>
					 	Account Title: College Account Number:82573627566457, BRANCH CODE: 3874<br>
					 	2. Allied Bank<br>Account Title: University of Management, Account Number: 825736275664- BRANCH CODE: 3874</p></b>
					  <b><p style="font-size: 11px;text-align: justify;">Note:-<br>
