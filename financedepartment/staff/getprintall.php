...
<body>
<?php if(isset($_POST['unpiadchallan']))
{
    ?>
    <div class = "container">
        <div id = "header">
        <br/>
            ...
            <p style = "text-align: right; font-size:12pt; font-weight:bold;">Un-Paid Challan Report</p>
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><b>".$rows['pcode']."</b></td>
                                <td><b>".$rows['pname']."</b></td>
                                <td><b>".$rows['createdon']."</b></td>
                                <td><b>".$rows['duedate']."</b></td>
                                <td><b>".$totalfee."</b></td>
                                <td><b>".$rows['month']."</b></td>
                                <td><b>".$rows['challanstatus']."</b></td>";
                                ?>
                          </tr>
