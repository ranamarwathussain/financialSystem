...
function showUser(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","getstudentchallan.php?q="+str,true);
    xmlhttp.send();
  }
}
</script>
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Un-Paid Challan Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Un-Paid Challan Section</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Un-Paid Challan Section</h6>
                    <?php echo $statusMsg; ?>
                    <!-- Textarea 2 rows height -->
<div class="form-outline">
   <b><label class="form-label" for="textAreaExample3">Un-Paid Challans Stats</label></b>

  <textarea disabled class="form-control" id="textAreaExample3" rows="2">Total Amount:
    <?php $query = "Select sum(fee) as feesum,sum(otherfee) as otherfeesum from challan where challanstatus='Pending';";
                      $rs = $conn->query($query);
                      $row=$rs->fetch_assoc();
                      echo $row['feesum']+$row['otherfeesum'];?></textarea>
                      <form action="getprintall.php" method="POST" target="_blank">
                       <button type="submit" name='unpiadchallan'  class="btn btn-primary btn-block">Print All Un-paid</button>
                       </form>
  ...
  <div class="modal fade bd-example-modal-lg" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
         <div class="modal-content">
				<form method="POST" action="challanrequest.php">	
     ...
     <div class="row">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                       $query = "Select * from challan where challanstatus='Pending';";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
                            ...
                            echo"
                              <tr>
                                ...
                                ?>
                                 ...
                                 <center>
                                <a href='getpaidapprovedchallan.php?challanid=<?php echo $rows['challanid']; ?>&totalfeeamount=<?php echo $totalfee; ?>&regnumber=<?php echo $rows['regnumber']; ?>&stdcnic=<?php echo $rows['stdcnic']; ?>&fname=<?php echo $rows['firstname']; ?>&lname=<?php echo $rows['lastname']; ?>&email=<?php echo $rows['email']; ?>&contact=<?php echo $rows['contact']; ?>&pcode=<?php echo $rows['pcode']; ?>&pname=<?php echo $rows['pname']; ?>&remarks=<?php echo $rows['challanremarks']; ?>'><button class="btn btn-info">Get Approved</button></a>
                                </center>
                                ...
                                echo "<td>";
                                ?>
                                <center><button class="btn btn-warning" data-toggle="modal" data-target="#edit_modal<?php echo  $rows['regnumber']?>"><?php echo $rows['regnumber']; ?></button> 
                                  <?php
                                  echo "</td>";
                                echo "
              ...
              <div class="col-xs-7 col-sm-6 col-lg-6">
               ...
               <div class="col-xs-7 col-sm-6 col-lg-6">
                <label>Payment Status:</label><span class="text-danger ml-2">*</span>
                 <input type="text" name="paymentstauts" class="form-control"  value="<?php echo $rows['challanstatus'];?>" disabled/> 
                 <input type="hidden" name="otherfee" class="form-control"  value="<?php echo $rows['otherfee'];?>" />
