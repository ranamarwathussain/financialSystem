       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Print Student Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Print Student Section</li>
            </ol>
          </div>
...
<div class="card col-xl-12">
            <div class="card-body col-xl-12" >
              <h5 class="card-title">Select Program<span class="text-danger ml-2">*</span></h5>
               <form method="post" action='getprintalldetailsstudents.php' target="_blank">
                ...
                <div class="col-xs-7 col-sm-6 col-lg-12">
                 <label class="form-control-label">Student Status<span class="text-danger ml-2">*</span></label>
                    ...
                    </div><button type="submit" name="check" class="btn btn-warning btn-block">Print Students</button>
