...
<body>
	<div class = "container">
		...
		<br/>
			...
			<p style = "text-align: right; font-size:12pt; font-weight:bold;">Program Wise Students Remainings</p>
...
echo "<b>".$date."</br>";?></p>
        ...
        <b style="font-size:14pt; font-weight:bold;"><div align="center">
            Program Wise Students Remainings<br>
            </div></b>
<style type="text/css">
...
<table class="table table-striped" style="align-content: left;">
                  ...
                  $query2 = "SELECT * FROM `student_balance` where  pcode='$pcode'  order by  bid";
...
<hr class="rounded">
               <?php
                   ...
                   echo"
                                ...
                                <td></td>
                                <td></td>
                                 <td><b>Total Amount Remaining for Program:".' '.$paidbalance['pname'].'-'.$paidbalance['pcode']."</b></td>
                                <td><b>".$paidbalance['fee']."</b></td>
                             </tr>";
                             ?>
					  </table> 
                      <style>
