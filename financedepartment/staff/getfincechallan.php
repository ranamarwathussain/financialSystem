       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Fine Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Fine Section</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Fine Section</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
            ...
            if($ret > 0)
            {
                 ?>  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span><i class='fas fa-plus' style='font-size:20px'></i>Fine Voucher</button>
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            echo"
                              <tr>
                                ...
                                ?>
                                  <center>
                                    <button class="btn btn-warning" data-toggle="modal" data-target="#edit_modal<?php echo  $rows['regnumber']?>"><?php echo $rows['regnumber']; ?></button> 
                                  <form action='generatefinevoucher.php' method="POST" target='_blank'>   
                                  <input type='hidden' name='regnumber' value="<?php echo $rows['fineid']; ?>" >
                                  <button type='submit' class="btn btn-info">-Get Print-</button></a>
                                </form>
                                </center>
    ...
    <div class="modal fade bd-example-modal-lg" id="edit_modal<?php echo $rows['regnumber']?>" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content modal-lg">
				<form method="POST" action="update_finechallan.php">	
					<div class="modal-header">
            ...
            <div class="modal-body">
             ...
             <div class="col-xs-7 col-sm-6 col-lg-12">
              ...
              <input type="hidden" name="fineid" class="form-control"   required="required" oninput="this.value = this.value.toUpperCase()" value="<?php echo $rows['fineid'];?>"/>
              </div>
