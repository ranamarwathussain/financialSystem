       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Rejected Requests Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Rejected Requests Section</li>
            </ol>
             <div class="form-outline">
   <b><label class="form-label" for="textAreaExample3">Rejected Discounts Stats</label></b>
  <textarea disabled class="form-control" id="textAreaExample3" rows="2">Total Amount:
    <?php $query = "Select sum(discountamount) as dm from student_discounts where discountstatus='Rejected';";
                      $rs = $conn->query($query);
                      $row=$rs->fetch_assoc();
                      echo $row['dm'];?></textarea>
                      <form action="getprintdiscount1.php" method="POST" target="_blank">
                       <button type="submit" name='rejecteddis'  class="btn btn-primary btn-block">Print Rejected</button>
                       </form>
 ...
 <div class="row">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                       $query = "Select * from student_discounts where discountstatus='Rejected';";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
