...
<body>
<?php if(isset($_POST['rejecteddis']))
{
    ?>
    <div class = "container">
        <div id = "header">
        <br/>
            ...
            <p style = "text-align: right; font-size:12pt; font-weight:bold;">Rejected Discounts Report</p>
