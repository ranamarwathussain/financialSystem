       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Student Lager Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Student Lager Section</li>
            </ol>
          </div>
...
<div class="card col-xl-12">
            <div class="card-body col-xl-12" >
              <h5 class="card-title">Select Student</h5>
               <form method="post" action='studentlagerbyid.php' target="_blank">
                    <div class="form-group row mb-12">
                     <div class="col-xl-12">
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="'.$rows['regnumber'].'" >'.$rows['regnumber'].'-'.$rows['firstname'].' '.$rows['lastname'].'-'.$rows['pcode'].'-'.$rows['pname'].'</option>';
                              }
                                 echo '</select>';
                            }
                           ?>  
                    ...
                    </div><button type="submit" name="check" class="btn btn-warning btn-block">Get Details</button>
          ...
          <!-- The Modal -->
           <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Daily Date Wise Challan/fine Deposit Details</h1>
          ...
          <div class="card col-xl-12">
            <div class="card-body col-xl-12" >
              <h5 class="card-title">Select Date</h5>
               <form method="post" action='lagerbydate.php' target="_blank">
                <div class="form-group row mb-12">
                <div class="col-xl-12">
                <input type="date" name="duedate" class="form-control"   required="required"/>
                </div>
                </div><button type="submit" name="getdate" class="btn btn-warning btn-block">Get Details</button>
           ...
           <!-- ///////////////////////////// -->
<div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Program Wise Deposit Amount Details</h1>
          ...
          <div class="card col-xl-12">
            <div class="card-body col-xl-12" >
              <h5 class="card-title">Select Program</h5>
               <form method="post" action='programwiselager.php' target="_blank">
                    <div class="form-group row mb-12">
                     <div class="col-xl-12">
                          <?php
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Program Wise Pending Amount Details</h1>
          ...
          <div class="card col-xl-12">
            <div class="card-body col-xl-12" >
              <h5 class="card-title">Select Program</h5>
               <form method="post" action='unpaidprogramwiseledger.php' target="_blank">
                    <div class="form-group row mb-12">
                     <div class="col-xl-12">
                          <?php
                        $qry= "SELECT * FROM program ORDER BY pid ASC";
                    ...
                    </div><button type="submit" name="unpaid" class="btn btn-warning btn-block">Get Details</button>
