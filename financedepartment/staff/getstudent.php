          ...
          <div class="modal-body">
             ...
             <div class="col-xs-7 col-sm-6 col-lg-12">
              ...
              <div class="col-xs-7 col-sm-6 col-lg-6">
                ...
                <input type="number" name="pcontact" class="form-control"  value="<?php echo $rows['padmission'];?>" required="required" disabled/>
                  <input type="hidden" name="padmission" class="form-control"  value="<?php echo $rows['padmission'];?>" required="required" />
                 ...
                 <div class="col-xs-7 col-sm-6 col-lg-12">
                 <label class="form-control-label">Select Discount On<span class="text-danger ml-2">*</span></label>
                        <select required name="discounttype"  class="form-control mb-3">
                ...
                <div class="col-xs-7 col-sm-6 col-lg-12">
                <label>Please Add Percentage</label><span class="text-danger ml-2">*</span>
                <input type="number" name="dispercent" class="form-control"      required/>
