...
<body>
	<div class = "container">
		...
		<br/>
			...
			<p style = "text-align: right; font-size:12pt; font-weight:bold;">Program Wise Deposite Ledger Report</p>
...
echo "<b>".$date."</br>";?></p>
        ...
        <b style="font-size:14pt; font-weight:bold;"><div align="center">
            Program wise Deposite Ledger<br>
            </div></b>
<style type="text/css">
...
<table class="table table-striped" style="align-content: left;">
                  ...
                  $query2 = "SELECT * FROM `challan` where challanstatus='Paid' AND pcode='$pcode'  order by  challanid";
...
<hr class="rounded">
               <?php
                   $query21 = "SELECT sum(fee) as fee, sum(otherfee) as otherfee,pname,pcode FROM `challan` where challanstatus='Paid' AND pcode='$pcode' order by  challanid";
