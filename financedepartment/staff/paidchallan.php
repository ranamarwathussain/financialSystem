       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Paid Challan Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Paid Challan Section</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Paid Challan Section</h6>
                    <?php echo $statusMsg; ?>
                    <div class="form-outline">
   <b><label class="form-label" for="textAreaExample3">Paid Challans Stats</label></b>
  <textarea disabled class="form-control" id="textAreaExample3" rows="2">Total Amount:
    <?php $query = "Select sum(fee) as feesum,sum(otherfee) as otherfeesum from challan where challanstatus='Paid';";
                      $rs = $conn->query($query);
                      $row=$rs->fetch_assoc();
                      echo $row['feesum']+$row['otherfeesum'];?></textarea>
                      <form action="getprintall1.php" method="POST" target="_blank">
                       <button type="submit" name='piadchallan'  class="btn btn-primary btn-block">Print All paid</button>
                       </form>
     ...
     <div class="row">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                       $query = "Select * from challan where challanstatus='Paid';";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
                            ...
                            echo"
                              <tr>
                                ...
                                <center><button disabled class="btn btn-warning" data-toggle="modal" data-target="#edit_modal<?php echo  $rows['regnumber']?>"><?php echo $rows['regnumber']; ?></button> 
                                   <a href='generatepaidchallan.php?regnumber=<?php echo $rows['challanid']; ?>' target='_blank'><button class="btn btn-info">Paid</button></a>
                                    <center>
