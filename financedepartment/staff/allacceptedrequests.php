       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Accepted Requests Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Accepted Requests Section</li>
            </ol>
            <div class="form-outline">
   <b><label class="form-label" for="textAreaExample3">Accepted Discounts Stats</label></b>
  <textarea disabled class="form-control" id="textAreaExample3" rows="2">Total Amount:
    <?php $query = "Select sum(discountamount) as dm from student_discounts where discountstatus='Approved';";
                      $rs = $conn->query($query);
                      $row=$rs->fetch_assoc();
                      echo $row['dm'];?></textarea>
                      <form action="getprintdiscount.php" method="POST" target="_blank">
                       <button type="submit" name='approvedis'  class="btn btn-primary btn-block">Print Accepted</button>
                       </form>
 ...
 <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Accepted Applications</h6>
                </div>
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                       $query = "Select * from student_discounts where discountstatus='Approved';";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
              ...
              <div class="col-xs-7 col-sm-6 col-lg-6">
                ...
                <input type="hidden" name="discountamount" class="form-control" value="<?php echo $rows['discountamount'];?>"  required="required" />
                 ...
                 <label class="form-control-label">Request Status<span class="text-danger ml-2">*</span></label>
                        <select  disabled name="requestapprove"   class="form-control mb-3" >
