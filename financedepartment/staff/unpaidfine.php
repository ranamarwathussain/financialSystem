       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Un-Paid Fine Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Un-Paid Fine Section</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Un-Paid Fine Section</h6>
                    <?php echo $statusMsg; ?>
                                        <!-- Textarea 2 rows height -->
<div class="form-outline">
   <b><label class="form-label" for="textAreaExample3">Un-Paid Fine Stats</label></b>
  <textarea disabled class="form-control" id="textAreaExample3" rows="2">Total Amount:
    <?php $query = "Select sum(fee) as feesum from fine where challanstatus='Pending';";
                      $rs = $conn->query($query);
                      $row=$rs->fetch_assoc();
                      echo $row['feesum'];?></textarea>
                       <form action="getprintfine.php" method="POST" target="_blank">
                       <button type="submit" name='unpiadfine'  class="btn btn-primary btn-block">Print All Un-paid</button>
                       </form>
     ...
     <div class="row">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                       $query = "Select * from fine where challanstatus='Pending';";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            echo"
                             ...
                             <td>";
                                ?>
                                <center>
                                <a href='getpaidapprovedfine.php?fineid=<?php echo $rows['fineid']; ?>&totalfine=<?php echo $rows['fee']; ?>&finetype=<?php echo $rows['finetype']; ?>' ><button class="btn btn-info">Get Approved</button></a>
                                </center>
                                <?php 
                                echo "</td>";
                                echo "<td>";
