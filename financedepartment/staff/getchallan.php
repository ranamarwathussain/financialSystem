       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Challan Section</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Challan Section</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Challan Section</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
            ...
            if($ret > 0)
            {
                 ?> <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span><i class='fas fa-plus' style='font-size:20px'></i>Generate Challan</button>
                 <?php
               }else
               {
                 ?>
                            ...
                            echo"
                              <tr>
                                ...
                                ?>
                                 ...
                                 <form action='generatechallan.php' method="POST" target='_blank'>   
                                  <input type='hidden' name='regnumber' value="<?php echo $rows['challanid']; ?>" >
                                  <button type='submit' class="btn btn-info">-Get Print-</button></a></center>
                                </form>
             ...
             <div class="col-xs-7 col-sm-6 col-lg-12">
              ...
              <div class="col-xs-7 col-sm-6 col-lg-6">
               ...
               <div class="col-xs-7 col-sm-6 col-lg-6">
                ...
                <input type="number" name="fee" class="form-control"  value="<?php echo $rows['fee'];?>" />
                
              </div>
              <div class="col-xs-7 col-sm-6 col-lg-6">
                <label>Other Charges:</label><span class="text-danger ml-2">*</span>
                 <input type="number" name="otherfee" class="form-control"  value="<?php echo $rows['otherfee'];?>" /> 
