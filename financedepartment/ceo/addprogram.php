...
if(isset($_POST['save'])){
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This Record Already Exists!</div>";
    }
    else{

    $query=mysqli_query($conn,"INSERT INTO `program`(`pid`, `pcode`, `pname`, `pcost`,`pduration`, `pfeemode`, `pdegree`, `pshift`,`empcode`,`empname`,`createdon`) VALUES ('','$pcode','$pname','$pcost','$pduration','$feemode','$degree','$shift','".$_SESSION['empcode']."','". $_SESSION['firstname'].''. $_SESSION['lastname']."',NOW())");
